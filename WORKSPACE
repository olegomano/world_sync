...
rust_proto_repositories(False)

load("@rules_rust//proto:transitive_repositories.bzl", "rust_proto_transitive_repositories")

rust_proto_transitive_repositories()

register_toolchains("//rust_client:proto-toolchain")
